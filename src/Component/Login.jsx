  ...
  return (
    <div>
      <Container>
        <Row>
          <Col sm={6} >
          <img src={img} className="Side_img" alt="Img" height={"95%"} />
          </Col>
          <Col sm={6}>
          <Card className='card'>
          ...
          <div className="Links">
            <p>Get the app.</p>
            <div>
             <a className='link_img' ><img src={play0} alt="" width={"150px"}/></a>
             <a className='link_img'><img src={play1} alt=""  width={"150px"}/></a>
            </div>
